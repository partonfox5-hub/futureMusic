...
const PAGES = {
    ...
    horde: {
        ...
        description:
            'Play THE HORDE free in the browser or on Quest: doubling waves on an infinite plain. Pick Horde creatures, Army Man plastic soldiers, Mixed, or War. One pistol. An X-button armory.',
        keywords:
            'THE HORDE, VR wave shooter, WebXR horde game, Quest browser shooter, free VR game, silhouette enemies, army men, war mode',
