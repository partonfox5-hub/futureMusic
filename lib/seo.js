...
const PAGES = {
    ...
    chess: {
        ...
        description:
            'Play Creature Chess free in the browser: draft original creatures onto every piece, battle on captures, and build a spell-and-trap deck. Unlock the $1 Alpha pack for extra units, cards, and 3D field.',
        keywords:
            'Creature Chess, character chess, browser chess game, monster chess, free HTML5 chess, Alpha pack, Future Music Collective',
        ...
        isFree: true,
        h1: 'Creature Chess',
        lede: 'Draft original champions onto every chess piece. Captures become battles. The core game is free; a $1 Alpha pack unlocks extra creatures, cards, and 3D field.',
        playHref: '/chess',
        playLabel: 'Play Creature Chess',
        faq: [
            {
                q: 'Is Creature Chess free?',
                a: 'Yes. The full army builder, classic chess, and bonus spells-and-traps mode are free. A $1 Alpha pack unlocks extra units, four cards, and the 3D field camera.',
            },
            {
                q: 'What is in the Alpha pack?',
                a: 'For $1 you unlock Zen Lord Statue, Sparklet, Tidrop, Chefcoon, Mushnaut, Griffonair, Golemheart, Starlizard, Slothcolossus, Stormcrown, Teleport, Megamorph, Duplicate, Ice Slick, and 3D field.',
            },
            {
                q: 'How do I buy the Alpha pack?',
                a: 'Open army builder or deck builder, tap any locked card, and continue to Stripe checkout for $1. After payment the pack unlocks in this browser.',
            },
        ],
