...
const LINKS = {
    ...
    chess: { href: '/chess', name: 'Creature Chess' },
    'zombie-defense': { href: '/zombie-defense', name: 'Zombie Outpost Defense' },
    paintcadia: { href: '/paintcadia', name: 'Paintcadia' },
    'fish-extractor': { href: '/fish-extractor', name: 'Fish Extractor' },
    starfighter: { href: '/starfighter', name: 'Starfighter' },
    ...
    horde: { href: '/horde', name: 'The Horde' },
    zoom: { href: '/zoom', name: 'Zoom' },
    bricks: { href: '/bricks', name: 'Blockbuild' },
    'battle-sphere-arena': { href: '/battle-sphere-arena', name: 'Battle Sphere Arena' },
...
const PAGES = {
    projects: {
        ...
        description:
            'Play free HTML5 browser games from Future Music Collective: Creature Chess, zombie tower defense, arcade action, animal survival, strategy, and painting combat. Also includes Hero Slayer alpha and a free random number generator.',
        keywords:
    ...
    numgen: {
        ...
        related: rel('projects', 'hero-slayer', 'zombie-defense', 'chess'),
        sitemapPri: '0.9',
    },
    chess: {
        kind: 'game',
        path: '/chess',
        title: 'Creature Chess — Free Browser Chess With Original Monsters',
        description:
            'Play Creature Chess free in the browser: draft original creatures onto every piece, battle on captures, and build a spell-and-trap deck. $1.99 packs unlock Terraform, Curse of Medusa, Rites of Flame, and larger Map theatres.',
        keywords:
            'Creature Chess, character chess, browser chess game, monster chess, free HTML5 chess, Terraform, Curse of Medusa, Future Music Collective',
        image: '/images/creature-chess-og.jpg',
        gameName: 'Creature Chess',
        genre: ['Strategy', 'Board game', 'Chess'],
        platform: ['Web Browser', 'HTML5'],
        playMode: 'SinglePlayer',
        isFree: true,
        h1: 'Creature Chess',
        lede: 'Draft original champions onto every chess piece. Captures become battles. The core game is free; $1.99 packs unlock Terraform, Curse of Medusa, Rites of Flame, and the Map Pack.',
        playHref: '/chess',
        playLabel: 'Play Creature Chess',
        faq: [
            {
                q: 'Is Creature Chess free?',
                a: 'Yes. The full army builder, classic chess, and bonus spells-and-traps mode are free. Four $1.99 packs unlock Terraform, Curse of Medusa, Rites of Flame (Resurrection and Sacrifice), and the Map Pack (medium field + RTS).',
            },
            {
                q: 'What is in the paid packs?',
                a: 'Terraform: rock, ground, grass, and fighting champions plus Terraform. Curse of Medusa: dark, water, and psychic champions plus the stone spell. Rites of Flame: fire, electric, and normal champions plus Resurrection and Sacrifice. Map Pack: 16×16 medium fields and 24×24 RTS. Each creature pack also includes a trap, a type boost, and a full court (3 pawns, knight, bishop, rook, king, queen).',
            },
            {
                q: 'How do I buy a pack?',
                a: 'From the main menu, open a pack tile to inspect every card up close, then continue to Stripe checkout for $1.99. After payment the pack unlocks in this browser.',
            },
        ],
        related: rel('projects', 'hero-slayer', 'domain', 'rampart'),
        sitemapPri: '0.85',
    },
    'hero-slayer': {
        kind: 'game',
    ...
    bricks: {
        kind: 'game',
        path: '/bricks',
        title: 'Blockbuild — $9.99 Stud-Brick Workshop (Desktop + VR)',
        description:
            'Unlock Blockbuild for $9.99: a quiet infinite stud-brick workshop. Snap bricks, melt, cannon, and minifigs on desktop and in VR. One-time purchase on Future Music Collective.',
        keywords:
            'Blockbuild, brick workshop, VR bricks, stud brick game, desktop VR building, Future Music Collective',
        image: '/images/blockbuild.jpg',
        gameName: 'Blockbuild',
        genre: ['Sandbox', 'Building', 'VR'],
        platform: ['Web Browser', 'HTML5', 'WebXR'],
        playMode: 'SinglePlayer',
        isFree: false,
        price: '9.99',
        eyebrow: 'Paid workshop',
        h1: 'Blockbuild',
        lede: 'A $9.99 stud-brick workshop for desktop and VR. Snap pieces on a quiet table, then unlock the full kit.',
        playHref: '/bricks',
        playLabel: 'Unlock Blockbuild — $9.99',
        tags: ['Sandbox', 'VR', 'Bricks', 'Paid'],
        about: [
            'Blockbuild is a stud-brick workshop: fly an empty sky, snap interlocking pieces, melt, cannon, and place minifigs. Desktop and WebXR.',
            'This page is the public paygate. One-time $9.99 unlocks the workshop on this website. Home network visitors skip checkout automatically.',
        ],
        faq: [
            {
                q: 'How much is Blockbuild?',
                a: 'One-time $9.99 on this website. There is no subscription.',
            },
            {
                q: 'Does it work in VR?',
                a: 'Yes. After unlock you can play on desktop or enter WebXR on a headset.',
            },
        ],
        related: rel('hero-slayer', 'battle-sphere-arena', 'chess', 'projects'),
        sitemapPri: '0.8',
    },
    'battle-sphere-arena': {
        kind: 'game',
        path: '/battle-sphere-arena',
        title: 'Battle Sphere Arena — $15 Zero-G VR Coliseum (Browser + WebXR)',
        description:
            'Unlock Battle Sphere Arena for $15: zero-g melee inside a livestreamed coliseum of linked spheres. Play in the browser or enter WebXR on a headset. One-time purchase on Future Music Collective.',
        keywords:
            'Battle Sphere Arena, VR melee, WebXR game, zero-g arena, browser VR, Quest browser game, Future Music Collective',
        image: '/images/battle-sphere-arena/cover.jpg',
        gameName: 'Battle Sphere Arena',
        genre: ['Action', 'VR', 'Arena'],
        platform: ['Web Browser', 'HTML5', 'WebXR'],
        playMode: 'SinglePlayer',
        isFree: false,
        price: '15.00',
        eyebrow: 'New release',
        h1: 'Battle Sphere Arena',
        lede: 'A $15 zero-g VR coliseum for desktop and WebXR. Fly, cut, and hunt before your power hits zero.',
        playHref: '/battle-sphere-arena',
        playLabel: 'Unlock Arena — $15',
        tags: ['VR', 'Action', 'Paid'],
        about: [
            'Battle Sphere Arena is a first-person zero-g melee set in a livestreamed coliseum of linked spheres.',
            'This page is the public paygate. One-time $15 unlocks browser and WebXR play on this website.',
        ],
        faq: [
            {
                q: 'How much is Battle Sphere Arena?',
                a: 'One-time $15 on this website. There is no subscription.',
            },
            {
                q: 'Does it work in VR?',
                a: 'Yes. After unlock you can play on desktop or enter WebXR in a headset browser.',
            },
        ],
        related: rel('hero-slayer', 'bricks', 'chess', 'projects'),
        sitemapPri: '0.9',
    },
    'zombie-defense': {
        kind: 'game',
    ...
    'fish-extractor': {
        kind: 'game',
        path: '/fish-extractor',
        title: 'Fish Extractor — Free Heist Fishing Browser Game',
        description:
            'Play Fish Extractor free online: hire a street crew, fish a toxic pond, sell on a live market, and extract by helicopter. HTML5, no download.',
        keywords:
            'Fish Extractor, fishing heist game, extraction game, free browser game, HTML5 fishing game, crew management game',
        image: '/images/fish-extractor-card.jpg',
        gameName: 'Fish Extractor',
        genre: ['Strategy', 'Action', 'Heist', 'Management'],
        platform: ['Web Browser', 'HTML5'],
        playMode: 'SinglePlayer',
        isFree: true,
        eyebrow: 'Free HTML5 game',
        h1: 'Fish Extractor',
        lede: 'A heist, except the vault is a pond. Hire a crew, pull fish, run the market, and extract before the cops and wolves close in.',
        playSrc: '/fish-extractor/index.html',
        fullscreenHref: '/fish-extractor/index.html',
        playLabel: 'Play Fish Extractor',
        tags: ['Heist', 'Fishing', 'Strategy', 'Free', 'Browser'],
        about: [
            'Fish Extractor is a free browser heist: you plan a crew, arm them, fish a rotating pond, and sell through a live candle chart before extraction.',
            'Jobs add electric fences, manholes, bushes, bionics, and a helicopter balloon chase. Hire unique faces with cuts, XP, and catchphrases.',
            'No download. Click to start, plan the job, deploy, extract.',
        ],
        howto: [
            'Open Play or fullscreen. Wait through the Shine More Online splash, then click to start.',
            'Hire and gear a crew on the planning board. Deploy when ready.',
            'Fish, sell, extract. Land the helicopter pad to keep the haul.',
        ],
        faq: [
            {
                q: 'Is Fish Extractor free?',
                a: 'Yes. It is an HTML5 browser game on futuremusic.online with no login required.',
            },
            {
                q: 'Do I need to download anything?',
                a: 'No. Play in any modern desktop or mobile browser.',
            },
        ],
        related: rel('paintcadia', 'zombie-defense', 'hero-slayer', 'projects'),
        sitemapPri: '0.85',
    },
    starfighter: {
        kind: 'game',
        path: '/starfighter',
        title: 'Starfighter — Free Space Hull Builder Browser Game',
        description:
            'Play Starfighter free online: grow a reactor hull from drifting wrecks, fuse lasers, EMP, and claws, and survive alien ships. HTML5, no download.',
        keywords:
            'Starfighter, hullcore, space shooter, ship builder, free browser game, HTML5 space game, reactor core game',
        image: '/images/starfighter-card.jpg',
        ...
        eyebrow: 'Free HTML5 game',
        h1: 'Starfighter',
        lede: 'You are the reactor. Fuse drifting wreck into a hull, rank up guns, and last as long as the dark will let you.',
        playSrc: '/starfighter/index.html',
        fullscreenHref: '/starfighter/index.html',
        playLabel: 'Play Starfighter',
        tags: ['Shooter', 'Builder', 'Arcade', 'Free', 'Browser'],
        about: [
            'Starfighter is a free browser arena: a one-hit reactor core wrapped in modular armor. Tetris plates, turrets, thrusters, fields, claws, batteries, generators, missiles, EMP, and time warps fuse on contact.',
            'Rank the same part twice to climb 1–5. Bank score between runs for damage, speed, efficiency, and hull upgrades. Aliens grow meaner the longer you live.',
            'No download. Shine More splash, click to start, ignite the core.',
        ],
        howto: [
            'Open Play or fullscreen. Wait through the Shine More Online splash, then click to start and Ignite.',
            'WASD to fly. Mouse aims the hull. Left click lasers, E EMP, middle click missiles, right click grab, Q time-warp, Space thrust, Esc pause.',
            'Smash matching wrecks together to rank them up. Survive, bank score, buy between-run upgrades.',
        ],
        faq: [
            {
                q: 'Is Starfighter free?',
                a: 'Yes. It is an HTML5 browser game on futuremusic.online with no login required.',
            },
            {
                q: 'Do I need to download anything?',
        ...
        related: rel('fish-extractor', 'paintcadia', 'zombie-defense', 'projects'),
        sitemapPri: '0.85',
    },
    'addiction-slayer': {
        kind: 'game',
    ...
    zoom: {
        kind: 'game',
        path: '/zoom',
        title: 'ZOOM — Draw a Dungeon, Then Crawl It (Free Browser FPS)',
        description:
            'ZOOM is a free 3D dungeon crawler: draw rooms and halls in the map maker, then crawl them in first person with lasers, robots, jetpack, skateboard, and Quest 3 VR.',
        keywords:
            'ZOOM game, dungeon crawler, map maker, 3D browser FPS, Quest 3 VR dungeon, free browser game, laser FPS',
        image: '/games/zoom/og.jpg',
        gameName: 'ZOOM',
        genre: ['Action', 'FPS', 'Dungeon Crawler', 'VR'],
        platform: ['Web Browser', 'WebXR', 'Meta Quest'],
        playMode: 'SinglePlayer',
        isFree: true,
        h1: 'ZOOM',
        faq: [],
        related: rel('neweden', 'rampart', 'hero-slayer', 'projects'),
        sitemapPri: '0.8',
    },
    horde: {
        kind: 'game',
        path: '/horde',
        title: 'THE HORDE — Free VR Wave Shooter in the Browser',
        description:
            'Play THE HORDE free in the browser or on Quest: doubling waves on an infinite plain. Horde, Army Man, Mixed, War, or Open World with a 2D map maker. Landships, exploding missiles, ride AI vehicles.',
        keywords:
            'THE HORDE, VR wave shooter, WebXR horde game, Quest browser shooter, free VR game, silhouette enemies, army men, war mode, open world, landship',
        image: '/games/horde/og.jpg',
        gameName: 'THE HORDE',
        genre: ['Shooter', 'Survival', 'VR', 'Arcade'],
        platform: ['Web Browser', 'WebXR', 'Meta Quest'],
        playMode: 'SinglePlayer',
        isFree: true,
        h1: 'THE HORDE',
        playHref: '/horde',
        playLabel: 'Play THE HORDE',
        faq: [
            {
                q: 'Is THE HORDE free?',
                a: 'Yes. It runs in the browser and in Meta Quest Browser. No download.',
            },
            {
                q: 'How do waves work?',
                a: 'Wave 1 is one creature. Each cleared wave doubles the spawn: 2, 4, 8, 16, and so on. Speed boosts get more common as you climb.',
            },
        ],
        related: rel('neweden', 'zoom', 'chess', 'projects'),
        sitemapPri: '0.8',
    },
    neweden: {
        kind: 'game',
...
function sitemapXml() {
    const urls = [
        ...
        { loc: ORIGIN + '/privacy', pri: '0.3', freq: 'monthly' },
        { loc: ORIGIN + '/terms', pri: '0.3', freq: 'monthly' },
        { loc: ORIGIN + '/battle-sphere-arena/quest', pri: '0.6', freq: 'monthly' },
