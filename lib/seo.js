...
const PAGES = {
    ...
    bricks: {
        ...
        related: rel('hero-slayer', 'chess', 'projects', 'zombie-defense'),
        sitemapPri: '0.8',
    },
    'zombie-defense': {
        kind: 'game',
    ...
    horde: {
        ...
        description:
            'Play THE HORDE free in the browser or on Quest: an infinite white plain, doubling waves of black silhouette creatures, a pistol that starts weak, and a Y-button armory. Limbs fall off. Only a clean kill counts.',
        keywords:
            'THE HORDE, VR wave shooter, WebXR horde game, Quest browser shooter, free VR game, silhouette enemies',
