...
import {bodyVolumes,projectVolume} from './mira-v2-contact.js?v=h3.1';
const V=()=>new T.Vector3();
import {GARMENTS} from './mira-v2-garments.js?v=h3.1';
export {GARMENTS} from './mira-v2-garments.js?v=h3.1';
import {garmentPattern,fabricMaterial} from './mira-v2-garment-patterns.js?v=h3.1';
export class Cloth {
