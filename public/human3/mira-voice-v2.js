import {speakNeural} from './mira-neural-voice.js?v=h3.1';
import {speakBasic} from './mira-basic-voice.js?v=h3.1';
import {localTranscribe,warmLocalSpeech,stopLocalSpeech} from './mira-local-speech.js?v=h3.1';
import {EMOTION_NAMES} from './mira-v2-features.js?v=h3.1';
