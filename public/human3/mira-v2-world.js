import {Destruction} from './mira-v2-destruction.js?v=h3.3';
import {buildHouse} from './mira-v2-house.js?v=h3.3';
...
export class MiraWorld {
 ...
 tex(file){if(!this._maps)this._maps={};if(this._maps[file])return this._maps[file];const t=new T.TextureLoader().load('/human3/assets/tex/'+file);t.colorSpace=T.SRGBColorSpace;t.wrapS=t.wrapT=T.RepeatWrapping;t.anisotropy=8;return this._maps[file]=t;}
