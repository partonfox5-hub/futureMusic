...
export const V2_EXTRA_SLIDERS=[
 ...
 {key:'handResponse',label:'Hand contact response',min:0,max:4,step:.05,value:1.35,section:'physics'},
...
export const HAIR_STYLES=['Long layers','Shoulder length','Soft bob','Swept back','Low bun','Pixie crop','Light short bob','High bun'];
