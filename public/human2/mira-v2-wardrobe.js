...
import {bodyVolumes,projectVolume} from './mira-v2-contact.js?v=9.3';
const V=()=>new T.Vector3();
import {GARMENTS} from './mira-v2-garments.js?v=9.3';
export {GARMENTS} from './mira-v2-garments.js?v=9.3';
import {garmentPattern,fabricMaterial} from './mira-v2-garment-patterns.js?v=9.3';
export class Cloth {
