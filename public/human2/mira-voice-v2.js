import {speakNeural} from './mira-neural-voice.js?v=10.0';
import {speakBasic} from './mira-basic-voice.js?v=10.0';
import {localTranscribe,warmLocalSpeech,stopLocalSpeech} from './mira-local-speech.js?v=10.0';
import {EMOTION_NAMES} from './mira-v2-features.js?v=10.0';
