import {populateGarmentRack} from './modules/human5-rack-garments.js?v=18.0.0';
import {createClothSkin} from './modules/human5-cloth-budget.js?v=18.0.0';
...
export {GARMENTS} from './mira-v2-garments.js?v=18.0.0';
import {garmentPattern,fabricMaterial} from './mira-v2-garment-patterns.js?v=18.0.0';
export class Cloth {
