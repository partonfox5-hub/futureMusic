import {populateGarmentRack} from './modules/human5-rack-garments.js?v=20.2.0';
import {createClothSkin} from './modules/human5-cloth-budget.js?v=20.2.0';
import * as T from 'three';
import {bodyVolumes,projectVolume} from './mira-v2-contact.js?v=20.2.0';
const V=()=>new T.Vector3();
import {GARMENTS} from './mira-v2-garments.js?v=20.2.0';
export {GARMENTS} from './mira-v2-garments.js?v=20.2.0';
import {garmentPattern,fabricMaterial} from './mira-v2-garment-patterns.js?v=20.2.0';
export class Cloth {
