import {applyNPCProfile,validateNPCProfile,exportNPCProfile} from './human5-npc-profile.js?v=20.2.0';
import {weldSkinNormals} from './human5-skin.js?v=20.2.0';
import {deformGeometry,validateField} from './human5-photo-field.js?v=20.2.0';
