import {installVegetation} from './human5-vegetation.js?v=18.0.0';
import {installHairCutting} from './human5-haircuts.js?v=18.0.0';
import {installBirds} from './human5-birds.js?v=18.0.0';
import {installFishing} from './human5-fishing.js?v=18.0.0';
import {installPopulation} from './human5-population.js?v=18.0.0';
