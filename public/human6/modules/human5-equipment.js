...
import {furnitureRoot} from '../mira-v2-furniture.js?v=19.1.0';
import {wrapMethod,disposeTree,clamp,V,rng} from './human5-common.js?v=19.1.0';
import {createScope} from './human5-scope.js?v=19.1.0';
import {playSfx,unlockSfx} from '../mira-v2-sfx.js?v=19.1.0';
