...
import {installCombat,ARMOR_PRESETS} from './human5-combat.js?v=19.1.0';
import {installPetRefinement} from './human5-pets.js?v=19.1.0';
import {installNPCBehavior,NPC_ROLES,NPC_MODES,FOLLOWER_ORDERS} from './human5-npc-behavior.js?v=19.1.0';
import {installNavigation} from './human5-navigation.js?v=19.1.0';
