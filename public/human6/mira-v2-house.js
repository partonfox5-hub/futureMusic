...
import {makeSurfaceMap,wallMaterial} from './mira-v2-walls.js?v=17.5.0';
import {placeStairs,placeFurniture,tagMovable} from './mira-v2-furniture.js?v=17.5.0';
import {detailToilet,detailFridge,detailMicrowave,detailSink,detailBathtub,detailLamp,detailTvStand,detailBed,detailNightstand,detailDresser,detailBookshelf,detailDesk,detailBarStool,detailCabinet,detailMirror,detailCounter,detailCoffee,detailTable} from './mira-v2-furnish.js?v=17.5.0';
import {installWeights} from './mira-v2-weights.js?v=17.5.0';
import {installLaundry,installPantry} from './mira-v2-laundry.js?v=17.5.0';
import {installPiano} from './mira-v2-piano.js?v=17.5.0';
