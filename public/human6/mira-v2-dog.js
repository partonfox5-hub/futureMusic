import {paletteSkinnedVertex} from './modules/human5-skinning.js?v=17.5.0';
import * as THREE from 'three';
import { DogModel, clamp } from './src/dog/Dog.js?v=17.5.0';
import { DogPaws, floorAt } from './src/dog/DogPaws.js?v=17.5.0';
import { DogJaw } from './src/dog/DogJaw.js?v=17.5.0';
import { DogTail } from './src/dog/DogTail.js?v=17.5.0';
import { DogFur } from './src/dog/DogFur.js?v=17.5.0';
import { DogAudio } from './src/dog/DogAudio.js?v=17.5.0';
import { DogAI } from './src/dog/DogAI.js?v=17.5.0';
import { DogAnim } from './src/dog/DogAnim.js?v=17.5.0';
import { DogNeeds } from './src/dog/DogNeeds.js?v=17.5.0';
import { DogItems } from './src/dog/DogItems.js?v=17.5.0';
import { DogBite } from './src/dog/DogBite.js?v=17.5.0';
import { BONE_NAMES } from './src/dog/Dog.js?v=17.5.0';
...
export function createDogSystem(input={}) {
  ...
  const ctx={...context},handles=[],audio=new DogAudio(),items=new DogItems(ctx),itemGrabs=new Map();let coat='#b68952',slowFrames=0,serial=0,raf=0,lastFrame=0,hostOwned=!!ctx.props||ctx.hostTick===true,readySeen=false,disposed=false;
  ...
  const step=dt=>{
    ...
    items.tick(dt);audio.tick();for(const h of [...handles]){h.tickGrab(dt);h.tickPet?.(dt);h._anim.tick(dt);h._fur.tick(dt,ctx.renderer);if(items.slow)h._fur.setLayers(2);}
  };
      ...
      const handle={
        ...
        tickPet(){
          ...
          for(let i=0;i<2;i++){
            ...
            handle.bark('greeting');handle.setWag(1);ai.state='alert';
