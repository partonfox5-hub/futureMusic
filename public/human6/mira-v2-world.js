import {captureFurniture,tagMovable} from './mira-v2-furniture.js?v=17.8.0';
import {Destruction} from './mira-v2-destruction.js?v=17.8.0';
import {buildHouse} from './mira-v2-house.js?v=17.8.0';
import {buildCastle,inCastleClearing} from './mira-v2-castle.js?v=17.8.0';
import {plantTerrain,scatterTrees,tickNature,chopTree as chopNature,ramTree as ramNature,terrainHeight} from './mira-v2-nature.js?v=17.8.0';
