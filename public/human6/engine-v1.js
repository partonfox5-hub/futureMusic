...
import { createMiraSystem, SLIDERS, FACE_TYPES, HAIR_COLORS } from "./mira-core.js?v=19.1.0";
import { DEFAULT_PERSONA, miraChat, miraSpeak, startMic } from "./mira-voice.js?v=19.1.0";
