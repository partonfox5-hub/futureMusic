...
import { ENEMIES, ENEMY_BY_ID } from "./config.js?v=psy2";
import { sdf3, floorY } from "./map.js?v=psy2";
import { makeRobot } from "./robots.js?v=psy2";
import { hurtFoe } from "./weapons.js?v=psy2";
