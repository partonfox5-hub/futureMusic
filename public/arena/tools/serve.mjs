...
const types={'.html':'text/html','.js':'text/javascript','.css':'text/css','.svg':'image/svg+xml','.jpg':'image/jpeg','.mp4':'video/mp4','.mp3':'audio/mpeg','.wav':'audio/wav','.png':'image/png','.json':'application/json','.txt':'text/plain'};
...
}).listen(port,'0.0.0.0',()=>console.log(`NetKnight preview listening on ${port}`));
