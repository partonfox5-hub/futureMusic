...
app.get(["/human3", "/human3/"], (req, res) => {
    humanHeaders(res);
    res.sendFile(path.join(__dirname, "public", "human3", "index.html"));
});
app.use("/human3", (req, res, next) => {
    humanHeaders(res);
    next();
});
...
app.use("/humantown", (req, res, next) => {
    humanHeaders(res);
    next();
});
